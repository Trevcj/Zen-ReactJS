...
import Navbar from "./NavbarArrow.js";
...
class About extends React.Component {
  ...
  handleScroll = (ev) => {
    var scrollLeft = ev.nativeEvent.target.scrollLeft;
    var offset = ev.nativeEvent.target.offsetWidth;
    var scrollWidth = ev.nativeEvent.target.scrollWidth;
    this.setState({ scrollP: this.scroll.scrollP = (scrollLeft / (scrollWidth - offset)) * 100 });
    console.log(this.scroll.scrollP);
  };

  render() {
    var style = {
      marginLeft: (this.scroll.scrollP * .7) + "%"
    }
    return (<div className="aboutComponent">
      ...
      <div id="carouselScroll" className="grid 2" onScroll={this.handleScroll.bind(this)}>
      ...
      <div className="fullBar">
        <div className="movingBar" style={style}>
        </div>
      </div>
      ...
      <div id="tableScroll" className="grid 4" onScroll={this.handleScroll.bind(this)}>
      ...
      <div className="grid 5">
        ...
        <p className="about-text">
          Our mission is to revolutionize how small business owners deal with all the red-tape, complexity and hassle of setting up a small business. We are revolutionizing the way businesses are created, legal entities are managed and how dealing with all the monthly and annual regulations and “red-tape” of staying in compliance with the government is handled by us.
        </p>
        <br></br>
        <br></br>
        <br></br>
